...
export default function VideoPopUpPlayer({}) {
	...
	const { smallMobile, mobile, tablet, initializeBreakpoints } =
		useBreakpointsStore();
	...
	return (
		<div className="relative">
			...
			>
				<Image
					src={'/compressed/video-placeholder.webp'}
			...
			<div
				className={`fixed bg-black/75 h-full w-full z-50 inset-0 transition-all delay-100 duration-300 ${
