...
export default function ArtistSlider({ children }: PropsWithChildren) {
            ...
            <div className="flex gap-8 order-1 lg:order-2 mx-auto lg:m-0 lg:flex-row flex-col items-center lg:items-start text-center">
                <div className="flex flex-col px-5 uppercase text-[#9E6C4D] gap-8 lg:mt-20">
                    ...
                    <div className="flex lg:flex-col gap-4 justify-center lg:justify-start">
                        <a href={artistSlides[currentSlideIndex].facebookUrl}>
                            <IconFacebook
                                width={35}
                                height={35}
                        ...
                        <a href={artistSlides[currentSlideIndex].youtubeUrl}>
                            <IconYouTube
                                width={35}
                                height={35}
                        ...
                        <a href={artistSlides[currentSlideIndex].instagramUrl}>
                            <IconInstagramRound
                                width={35}
                                height={35}
